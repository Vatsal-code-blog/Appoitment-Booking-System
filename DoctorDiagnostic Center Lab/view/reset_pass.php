...
<aside class="menu-sidebar d-none d-lg-block">
    ...
    <script type="text/javascript">
    	$('#btn_reset').click(function(){
            ...
            var password_length = $.trim(pass1).length;

    		if(pass1 != '' && pass2 != '') 
    		{
    			if (pass1 == pass2 && $uppercase && $lowercase && $number && password_length >= 8) 
    			{
	    			$.ajax({
    			...
    			{
    				$('#error').html("Password Does Not Match OR select Any Strong Password").css("color","red");
    			}
