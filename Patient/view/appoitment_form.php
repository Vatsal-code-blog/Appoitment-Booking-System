...
<head>
    <title>Appoitment Booking Form</title>
...
<main>
    ...
    <center><h1>Book An Appoitment</h1></center> 
  </div><br><br>
                            ...
                            <div class="row" style="font-size: 20px;">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-box email-icon mb-30">
                                        <input type="email" name="patient_email" id="patient_email" placeholder="email">
                                    </div>
                                </div>
                                 <div class="col-lg-6 col-md-6">
                                    <div class="form-box email-icon mb-30">
                                        <input type="text" name="patient_mobile" id="patient_mobile" placeholder="Phone">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-30">
                                    <div class="select-itms">
                                        <select name="select" id="doctor_name">
                                            <option>Concultting Doctor</option>
                                            <?php
