...
class Book_appoitment extends Connection
{
	...
	function appoitment()
	{
		 ...
		 if(mysqli_num_rows($check_appoitment)>0)
			...
			{
				$query_appoitment_book = " INSERT INTO `appointment_booking`(`patient_id`, `patient_name`, `doctor_name`, `doctor_fees`, `patient_email`, `patient_mobile`, `appointment_date`, `appointment_time`) VALUES ('$patient_id','$patient_name','$doctor_name','$doctor_rate','$patient_email','$patient_mobile','$date','$time') ";
