    ...
    <script type="text/javascript">
       $('#btn_register').click(function(){
        ...
        $('#pass_error').html("");
            ...
            var display_pic = $('#display_pic').val();

    
            if (username != '' && email != '' && mobile != '' && password != '' && conf_password != '') 
            {
                if (password == conf_password) 
                {
                    $.ajax({
                        url : '../modal/register_admin.php',
                        method : 'post',
                        data : $("#Registration_form input").serialize(),
                ...
                {
                    $('#pass_error').html("Password Does Not Match").css("color","red");
                }
            }
            else
            {
